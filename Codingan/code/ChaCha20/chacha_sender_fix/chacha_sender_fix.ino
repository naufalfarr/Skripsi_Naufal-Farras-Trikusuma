...
// Existing ChaCha20 Implementation (quarterRound, chacha20Block, chacha20EncryptDecrypt) remains the same
...
void loop() {
    ...
    // Encrypt the message
    uint8_t* ciphertext = encryptMessage(plaintextSets[0], encryptedLen, encryptionTime);
