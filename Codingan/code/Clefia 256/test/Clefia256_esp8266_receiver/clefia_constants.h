#ifndef CLEFIA_CONSTANTS_H
#define CLEFIA_CONSTANTS_H

#include <Arduino.h>
#include <pgmspace.h>

// CLEFIA Algorithm Constants
// Stored in PROGMEM to save RAM on ESP8266

// Round constants for 256-bit key
...
// Optional: Define helper functions for accessing these constants
// Note: These are declared here but should be implemented in your main file
...
// CLEFIA Configuration Constants
// constexpr uint16_t CLEFIA_BLOCK_SIZE = 16;
// constexpr uint16_t CLEFIA_KEY_SIZE = 32;
// constexpr uint16_t CLEFIA_ROUNDS = 32;

#endif // CLEFIA_CONSTANTS_H